    ...
    <div className="w-screen ">
      ...
      <div id="landingBanner" className="w-screen h-[45vh] lg:h-[88vh]">
        <div className="pt-[calc(3rem+1vw)] pl-[calc(1.5rem+1vw)] 
          ...
          <button className="w-[calc(8vw+1rem)] lg:h-[7vh]  rounded-md text-[14px] px-3 lg:px-0 lg:py-0 py-2 lg:py-0  bg-[#FDC000] lg:rounded-md lg:text-[20px] popins-noweight font-semibold mt-[2.5rem]">See Our Fleet</button>
        </div>
      </div>
