            ...
            <div className='w-screen'>
                ...
                <div className=' w-fit flex flex-col gap-6 lg:gap-5 mx-auto -mt-[100px] lg:-mt-[150px] pb-20'>
                    ...
                    <div className='flex lg:gap-3'>
                        <img src={s1} className="w-[24vw] h-[12vh] lg:w-[18vw] lg:h-[47vh]" />
                        <img src={s2} className="w-[24vw] h-[12vh] lg:w-[18vw] lg:h-[47vh]" />
                        <img src={s3} className="w-[24vw] h-[12vh] lg:w-[18vw] lg:h-[47vh]" />
                        <img src={s4} className="w-[24vw] h-[12vh] lg:w-[18vw] lg:h-[47vh]" />
                    </div>
                </div>
            </div>
        </>
